...
class Edge:
    ...
    def intersect_and_update_range(self, edge:'Edge') -> bool:
        ...
        if intersection is None:
            ...
            edge.update_range(intersection.x, ToThe.LEFT if a_facing == EdgeDirection.FACING_RIGHT else ToThe.RIGHT)
            self.update_range(intersection.x, ToThe.LEFT if b_facing == EdgeDirection.FACING_RIGHT else ToThe.RIGHT)
            return True
